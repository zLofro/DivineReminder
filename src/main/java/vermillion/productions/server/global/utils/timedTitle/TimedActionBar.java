package vermillion.productions.server.global.utils.timedTitle;

import net.minecraft.server.network.ServerPlayerEntity;
import net.minecraft.text.Text;
import vermillion.productions.Main;
import vermillion.productions.server.global.utils.chat.ChatFormatter;
...
public class TimedActionBar {
    ...
    public static void processActionBars(String name) {
        var server = Main.getInstance().serverManager().minecraftServer();
